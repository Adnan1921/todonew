...
class TodoListsTest < ApplicationSystemTestCase
  ...
  test "creating a Todo list" do
    ...
    fill_in "Difficulty level", with: @todo_list.difficulty_level
    fill_in "Task description", with: @todo_list.task_description
    fill_in "Task time", with: @todo_list.task_time
    fill_in "Task title", with: @todo_list.task_title
