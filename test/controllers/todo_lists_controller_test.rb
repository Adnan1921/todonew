...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { difficulty_level: @todo_list.difficulty_level, task_description: @todo_list.task_description, task_time: @todo_list.task_time, task_title: @todo_list.task_title } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { difficulty_level: @todo_list.difficulty_level, task_description: @todo_list.task_description, task_time: @todo_list.task_time, task_title: @todo_list.task_title } }
